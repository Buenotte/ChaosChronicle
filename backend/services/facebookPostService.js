...
Напиши КРАТКИЙ, ёмкий вирусный пост (40-70 слов) с сочным сатирическим гротеском и парадоксом из новости.

СТИЛЕВОЙ ТОН:
${styleConfig.tone}

СТРОГИЕ ОБЯЗАТЕЛЬНЫЕ ТРЕБОВАНИЯ К ПОСТУ:
1. Краткость и гротеск: 1-2 предложения с сутью новости и яркой физической метафорой/парадоксом (как в сценарии).
