...
const TITLE_STYLES = {
  ...
  analytics: {
    name: '🧠 Увлекательная Аналитика (Без гротеска)',
    desc: 'Серьезный геополитический и военно-стратегический анализ без цирка и гротеска. Точный диагноз и цена событий.',
  },
  kasjanov: {
...
2. БЕЗ ЦИРКА, БЕЗ ГРОТЕСКА, БЕЗ КАРИКАТУР:
   - Серьезный нерв, геополитический контекст, точный диагноз ситуации (например: "ЦЕНА ОШИБКИ КРЕМЛЯ В КУРСКЕ", "РЕАЛЬНЫЙ ТУПИК ВОЕННОЙ МАШИНЫ", "ПОЧЕМУ ЛОМАЕТСЯ ЛОГИСТИКА ФРОНТА").
3. БЕЗ кавычек, БЕЗ нумерации, БЕЗ точек на конце.
4. ВЫВОД: РОВНО 10 строк, по одному заголовку на строку (капсом UPPERCASE).`
...
2. 💥 ОСТРЫЙ ПАРАДОКС И РЕАЛИСТИЧНАЯ ИРОНИЯ:
