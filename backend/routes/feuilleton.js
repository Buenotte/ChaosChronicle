...
const STYLES = {
  ...
  kasjanov: {
    ...
    label: '🪖 Юрий Касьянов',
    focus: 'Военно-технический реализм, рубленый синтаксис, акцент на ТТХ, дронах, РЭБ, логистике, презрение к очковтирательству, жесткий призыв к реальным действиям.',
  },
  klimovski: {
...
6. Текст должен звучать слитно, ритмично и мощно для записи голосовым ИИ.`;
